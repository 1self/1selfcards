...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app.card-stack', {
    url: "/card-stack",
    views: {
      'menuContent': {
        templateUrl: "templates/card-stack.html",
  ...
  .state('app.single2', {
    ...
    views: {
      'menuContent': {
        templateUrl: "templates/card-back.html",
        controller: 'CardBackCtrl'
      }
    }
  });
  // if none of the above states are matched, use this as the fallback
  $urlRouterProvider.otherwise('/app/card-stack');
});
